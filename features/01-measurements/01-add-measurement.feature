Feature: Add a measurement
  ...
  Scenario: Add a measurement with valid (numeric) values
    ...
    @new
    Scenario: Add a measurement with valid (numeric) values from new instruments
        # POST /measurements
        When I submit a new measurement as follows:
          | timestamp                  | pressure |
          | "2015-09-01T17:00:00.000Z" | 88.80    |
        Then the response has a status code of 201
        And the Location header has the path "/measurements/2015-09-01T17:00:00.000Z"
